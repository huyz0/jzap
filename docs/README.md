...
- [delivery-plan.md](delivery-plan.md) — the delivery plan, in 7 phases, each stage with a
  goal, a binary definition of done, and a task list. Includes kill criteria.
